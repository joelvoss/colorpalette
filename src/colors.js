export const colorBaseVariants = [
  '50',
  '100',
  '200',
  '300',
...
export const colorAlternativeVariants = ['A100', 'A200', 'A400', 'A700'];
...
export function hexToRgb(color) {
  ...
  const [r, g, b] = colorStr.map(col => parseInt(col, 16));
  return [r, g, b, 1];
}
